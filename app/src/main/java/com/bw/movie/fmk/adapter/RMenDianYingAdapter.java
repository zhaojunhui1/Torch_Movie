 ...
 * @Description:
 */
public class RMenDianYingAdapter extends RecyclerView.Adapter<RMenDianYingAdapter.Holder> {

    public List<RMenBean.ResultBean> data;
    public Context mContext;

    public RMenDianYingAdapter(List<RMenBean.ResultBean> data, Context mContext) {
        this.data = data;
