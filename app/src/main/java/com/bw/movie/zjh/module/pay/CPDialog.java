package com.bw.movie.zjh.module.pay;
...
public class CPDialog extends Dialog{
    ...
    protected CPDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public void initDialog() {
        ...
        tvPositiveButton = findViewById(R.id.tvPositiveButton);
        tvNeutralButton = findViewById(R.id.tvNeutralButton);
        tvNegativeButton = findViewById(R.id.tvNegativeButton);
    }
