...
import com.bw.movie.zjh.module.adapter.MyLikeCinemaAdapter;
 ...
 * version: 1.0
 */
public class MyLikeCinemaFragment extends BaseFragment implements IView {
    ...
    private int page = 0;
    private MyLikeCinemaAdapter mAdapter;
    private Handler handler = new Handler();

    @Override
    protected int setView() {
        return R.layout.fragment_my_like_cinema;
    }
    ...
    protected void initData(Bundle savedInstanceState) {
        page = 1;
        //适配器
        mAdapter = new MyLikeCinemaAdapter(getActivity());
    ...
    private void joinApi(int page) {
        ...
        iPresenter.getPresenterData(Apis.MY_LIKE_CINEMA_GET, map, MyLikeCinemaBean.class);
        //布局管理器
    ...
    public void viewDataSuccess(Object data) {
        if (data instanceof MyLikeCinemaBean){
            MyLikeCinemaBean likeMovieBean = (MyLikeCinemaBean) data;
            if (page == 1){
